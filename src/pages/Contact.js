    ...
    <>
      ...
      <div id="contact-info" className="contact-container">
        <div className="container mt-5">
          <div className="row">
            <div className="col">
              <h1 className="fw-bold display-1 text-center mt-2 pt-2 text-white bg-black r-2">
                Contact Me
              </h1>
              <form className="contact-form">
                ...
                <button type="submit" className="btn btn-animated">Send Message</button>
              </form>

              <section id="contact" className="social-section py-5">
